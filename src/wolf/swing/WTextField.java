...
public class WTextField extends JTextField {
	 ...
	 */
	public WTextField(String placeholder) {
		this(placeholder, 0);
	}
	
	/**
	 * Create a limited length text field with a placeholder.
	 * 
	 * @param placeholder the placeholder text for the field.
	 * @param length the maximum text length of the field.
	 */
	public WTextField(String placeholder, int length) {
	...
	/**
	 * Set the characters that are allowed to be entered in the field. Use null for every character.
	 * 
